...
function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("NEXUS Hub") then
				makefolder("NEXUS Hub")
			end
			if not isfolder("NEXUS Hub/Blox Fruits/") then
				makefolder("NEXUS Hub/Blox Fruits/")
			end
			if not isfile("NEXUS Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("NEXUS Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("NEXUS Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("NEXUS Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("NEXUS Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
local Win = library:Evil("NEXUS Hub | ","",_G.Logo )
